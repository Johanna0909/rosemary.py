...
#here we can specify the number of servings of 16 cookies we want (or let it be random!)
number= random.randint (1,10)
print(number)
print ('times a serving of 16 cookies') 
...
for i in range(number):
    for i in range (16):
        tray.add(bowl.take(f'1/{16*number}'))
